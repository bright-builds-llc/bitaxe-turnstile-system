...
reacquisition, threat, and non-claim rules. The dependency-ordered child tickets let possession,
browser, deployment trust, and firmware adapters proceed after the transport fixtures, then
converge on one cross-repository hardware proof that closes BWG Core Ticket 23. The deployment
trust prerequisite was inserted later without changing completed ticket identities. Resolved
Tickets 21 and 22 remain closed and their existing evidence is not reinterpreted.

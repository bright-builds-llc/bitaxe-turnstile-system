CREATE TABLE relying_service.governance_retention_jobs (
...
CREATE TABLE relying_service.governance_retention_items (
    job_id UUID NOT NULL REFERENCES relying_service.governance_retention_jobs(job_id),
...
CREATE TABLE relying_service.governance_tombstones (
...
CREATE TABLE relying_service.governance_audit_events (

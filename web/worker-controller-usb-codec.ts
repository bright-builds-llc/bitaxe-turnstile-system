...
export type WorkerControllerUsbRequestFor<Version extends string, Grant, Renewal> = {
...
export type WorkerControllerUsbResponseFor<Version extends string> =
  | {
      protocolVersion: Version;
      requestId: string;
      ok: true;
...
export type WorkerControllerUsbCodecProfile<Version extends string, Grant, Renewal> = {
  protocolVersion: Version;
  label: string;
...
export function decodeWorkerControllerUsbRequestFor<Version extends string, Grant, Renewal>(
  frame: Uint8Array,
  profile: WorkerControllerUsbCodecProfile<Version, Grant, Renewal>,
): WorkerControllerUsbRequestFor<Version, Grant, Renewal> {
  ...
  const requiresPayload = ["start_lease", "renew_lease", "restore"].includes(command);
...
export function decodeWorkerControllerUsbResponseFor<Version extends string>(
  frame: Uint8Array,
  profile: WorkerControllerUsbCodecProfile<Version, unknown, unknown>,
): WorkerControllerUsbResponseFor<Version> {
...
export function decodeWorkerControllerUsbEnvelopeFor<Version extends string>(
  frame: Uint8Array,
  profile: WorkerControllerUsbCodecProfile<Version, unknown, unknown>,
...
export function assertWorkerControllerUsbCorrelationFor<Version extends string>(
